...
public class OrderVo {
    ...
    public Long getRequirementSubId() {
        return requirementSubId;
    }

    public void setRequirementSubId(Long requirementSubId) {
        this.requirementSubId = requirementSubId;
    }
